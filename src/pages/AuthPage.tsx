...
import { ArrowLeft, Mail, Lock, User, UserCheck } from "lucide-react";
...
const AuthPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Redirect based on role (this would come from the response)
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-strong backdrop-blur-sm bg-card/80">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Welcome to Referrify</CardTitle>
            <CardDescription>
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full gradient-primary text-white transition-smooth"
                    disabled={isLoading}
                  >
